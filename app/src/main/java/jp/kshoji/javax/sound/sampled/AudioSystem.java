 ...
 * </table>
 *
 * The property value consists of the provider class name and the mixer name, separated by the hash mark (&quot;#&quot;). The provider class name is the fully-qualified name of a concrete {@link MixerProvider mixer
...
public class AudioSystem {
	 ...
	 * 
	 * @return an array of {@link FormatConversionProvider FormatConversionProvider} objects representing the available format converters. If no format converters readers are available on the system, an array of
	 ...
	 * 
	 * @return a List of {@link AudioFileReader AudioFileReader} objects representing the installed audio file readers. If no audio file readers are available on the system, an empty List is returned.
	 */
