...
import jp.kshoji.javax.sound.sampled.Mixer;
...
public abstract class MixerProvider {
	 ...
	 * @see #getMixer(jp.kshoji.javax.sound.sampled.Mixer.Info) getMixer(Mixer.Info)
	 * @see #isMixerSupported(jp.kshoji.javax.sound.sampled.Mixer.Info) isMixerSupported(Mixer.Info)
	 */
	 ...
	 * <p>
	 * The full set of the mixer info objects that represent the mixers supported by this {@code MixerProvider} may be obtained through the {@code getMixerInfo} method. Use the {@code isMixerSupported} method to test whether this
	 * {@code MixerProvider} supports a particular mixer.
	 *
	 * @param info
