...
public class ModelStandardDirector implements ModelDirector {
    ...
    private boolean isValidPerformer(ModelPerformer performer)
    {
        if(performer.getKeyFrom() > performer.getKeyTo()) return false;
        if(performer.getVelFrom() > performer.getVelTo()) return false;
        return true;
    }
    ...
    private void buildindex() {
        ...
        for (ModelPerformer performer : performers) {
            if(!isValidPerformer(performer)) continue;
