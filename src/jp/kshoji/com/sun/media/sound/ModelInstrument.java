 ...
 *
 * <p>
 * Performers are used to define what voices which will playback when using the instrument.<br>
 *
 * ChannelMixer is used to add channel-wide processing on voices output or to define non-voice oriented instruments.<br>
 *
