...
/**
 * ModelChannelMixer is used to process channel voice mix output before going to master output.<br>
 * It can be used to:<br>
 * <ul>
 * <li>Implement non-voice oriented instruments.</li>
 * <li>Add insert effect to instruments; for example distortion effect.</li> </ui>
 * <p>
